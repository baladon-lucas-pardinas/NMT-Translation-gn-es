...
TO=1
EARLY_STOPPING=7
RUN_ID="augmentation_${FINETUNING_EPOCHS}_${SRC}_${TRG}_${TYPE}"
...
HYPERPARAMETER_GRID_FILES="${PROJECT_PATH}/artifacts/parameters/train_augmentation/tuned/${TYPE}_${SRC}_${TRG}.json"
