...
/marian/build/marian \
 ...
 --model  /docker/home/marianmt/artifacts/models/model_gpu.npz --after-epochs 3 \
 ...
 --seed 1234 --cpu-threads 0 --log /docker/home/marianmt/logs/marian/model.log --valid-log /docker/home/marianmt/logs/marian/dev.log \
 --valid-sets /docker/home/marianmt/tests/data/val_gn.txt /docker/home/marianmt/tests/data/val_es.txt\
 --valid-metrics bleu chrf cross-entropy translation \
