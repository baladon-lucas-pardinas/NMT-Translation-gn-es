class HyperparameterTuningConfig:
    ...
    def copy(self, deep=False):
        ...
        return HyperparameterTuningConfig(run_id=self.run_id,
                                          tuning_grid_files=self.tuning_grid_files.copy() \
                                            if (deep and self.tuning_grid_files) else self.tuning_grid_files,
                                          tuning_params_files=self.tuning_params_files.copy() \
                                            if (deep and self.tuning_params_files) else self.tuning_params_files,
...
def get_hyperparameter_tuning_config(run_id=None,
                                     tuning_grid_files=None,
                                     tuning_params_files=None,
    ...
    return HyperparameterTuningConfig(run_id=run_id,
